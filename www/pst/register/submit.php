...
// 넘어온 데이터 확인
if(!isset($_POST['nick'])) {echo "error:: cannot find email"; return;}
if(!isset($_POST['password'])) {echo "error:: cannot find password"; return;}
if(!isset($_POST['password_repeat'])) {echo "error:: cannot find repeat password"; return;}
